...
public class LinkedListBuilderTest {
    ...
    LinkedListBuilder linkedListBuild;

    @Before
    public void initialize(){
        
        linkedListBuild = new LinkedListBuilder();
    }
    ...
    public void buildListTest1(){
        ...
        int actual = linkedListBuild.buildList(testArray).size();
    ...
    public void buildListTest2(){
        ...
        names.add("JoJo");
        names.add("Star");
        int actual = linkedListBuild.buildList(names).size();
    ...
    public void buildListTest3(){
        ...
        int actual =  linkedListBuild.buildList(testArray1, testArray2).size();
        int expected = 6;
    ...
    public void buildListTest4(){
        ...
        int actual = linkedListBuild.buildList(set1, set2).size();
