...
public class LinkedListBuilderTest {
    ...
    public void collectionBuildTest(){
        ...
        List<Object> expected=new LinkedList<Object>(values);
    ...
    public void arraysBuildTest(){
        ...
        List<Object> expected=new LinkedList<Object>(Arrays.asList(combo));
    ...
    public void collectionsBuildTest(){
        ...
        List<Object> expected=new LinkedList<Object>(combo);
